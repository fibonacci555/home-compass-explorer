...
const RegisterPage = () => {
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <Navbar />
      <div className="flex items-center justify-center min-h-[calc(100vh-4rem)] py-10 px-4">
        <motion.div 
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">Sign up to get started with Estate</p>
          </div>
          ...
          <div className="mt-6 flex items-center justify-center">
            ...
            <Link to="/login" className="ml-1 text-blue-600 dark:text-blue-400 text-sm hover:underline">
              Sign in
            </Link>
          </div>
