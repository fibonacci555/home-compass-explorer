      ...
      <div className="flex items-center justify-center h-[calc(100vh-4rem)] px-4">
        ...
        >
          <div className="text-center mb-6">
            ...
            <p className="text-gray-600 dark:text-gray-400 mt-1">Sign in to continue to Estate</p>
          </div>
          ...
          <div className="mt-6 flex items-center justify-center">
            ...
            <Link to="/register" className="ml-1 text-blue-600 dark:text-blue-400 text-sm hover:underline">
              Sign up
            </Link>
          </div>
